                        ...
                        <div class="col-xs-4 product-men">
                            <div class="men-pro-item simpleCart_shelfItem">
                                <div class="men-thumb-item">
                                    <img src="{{ asset($product->product_image) }}" alt="product-image" height="150" width="150">
                                ...
                                <div class="item-info-product ">
                                    ...
                                    <div class="info-product-price">
                                        <span class="item_price">{{ '$'.$product->product_discount_price }}</span>
                                        <del>{{ '$'.$product->product_orginal_price }}</del>
                                    </div>
                    ...
                    <div class="product-sec1">
                        ...
                        <div class="col-md-4 product-men">
                            <div class="men-pro-item simpleCart_shelfItem">
                                ...
                                <div class="item-info-product ">
                                    <h4>
                                        <a href="{{ route('product-details',['id' => $product->id]) }}">Organicana Red Chilli</a>
                                    </h4>
                                    <div class="info-product-price">
                ...
                <ul id="flexiselDemo1">
                    <li>
                        <div class="w3l-specilamk">
                            ...
                            <div class="product-name-w3l">
                                <h4>
                                    <a href="{{ route('product-details',['id' => $product->id]) }}">Aashirvaad, 5g</a>
                                </h4>
                    ...
                    <li>
                        <div class="w3l-specilamk">
                            ...
                            <div class="product-name-w3l">
                                <h4>
                                    <a href="{{ route('product-details',['id' => $product->id]) }}">Kissan Tomato Ketchup, 950g</a>
                                </h4>
                                <div class="w3l-pricehkj">
                                    <h6>$99.00</h6>
                                    <p>Save $20.00</p>
                    ...
                    <li>
                        <div class="w3l-specilamk">
                            ...
                            <div class="product-name-w3l">
                                <h4>
                                    <a href="{{ route('product-details',['id' => $product->id]) }}">Madhur Pure Sugar, 1g</a>
                                </h4>
                                <div class="w3l-pricehkj">
                                    <h6>$69.00</h6>
                                    <p>Save $20.00</p>
                    ...
                    <li>
                        <div class="w3l-specilamk">
                            ...
                            <div class="product-name-w3l">
                                <h4>
                                    <a href="{{ route('product-details',['id' => $product->id]) }}">Cadbury Choclairs, 655.5g</a>
                                </h4>
                                <div class="w3l-pricehkj">
                                    <h6>$160.00</h6>
                                    <p>Save $60.00</p>
                    ...
                    <li>
                        <div class="w3l-specilamk">
                            ...
                            <div class="product-name-w3l">
                                <h4>
                                    <a href="{{ route('product-details',['id' => $product->id]) }}">Sprite, 2.25L (Pack of 2)</a>
                                </h4>
                                <div class="w3l-pricehkj">
                                    <h6>$180.00</h6>
                                    <p>Save $30.00</p>

...
<script>
    ...
    //
    //     $.ajax({
    //         url: "get-category-name/"+categoryId,
    //         method: "GET",
    //         dataType: "JSON",
...
<script>
    function setProductCode() {
        ...
        $.ajax({
            ...
            success: function (response) {
                var categoryName = response.category_name;
                var brandame = response.brand_name;
                var a = categoryName.slice(0, 3);
                var b = a.toUpperCase();
                var c = brandame.slice(0, 3).toUpperCase();
                var d = productName.slice(0,3).toUpperCase();

                var result = b+'-'+c+'-'+d+'-'+response.lastProductId;
                $('#productCode').val(result);
            }
        });
    }
